...
scene during the Battle of Yavin as seen in Star Wars: A New Hope –
Episode 4. There are two scenarios I would like to demonstrate in using
the events of this movie scene.

## What

In order to accomplish these goals, I will use the Death Star attack
scene during the Battle of Yavin as seen in Star Wars: Episode IV - A
New Hope. There are two scenarios (described below) I will use to
demonstrate concepts that have been learned in this class, and may be
taught to other audiences.

## Why

Using pop culture references have the positive impact of generating
...
X-Wing’s and Gold Squadron was comprised strictly of Y-Wings. Each
...
the probabilities associated with them. Will use RStudio to calculate
...
in this case a hit. Also note that RStudio deliberately modifies the
scope of the representation due to the size.
...
Let’s use coding in R to confirm how many “hits” there are in the data
set:
...
Let us also use coding in R to determine how many “misses” there are:
...
Next, demonstrate this data visually with the tools R gives us.
...
![](README_files/figure-markdown_strict/unnamed-chunk-63-2.png)

    boxplot(x)

![](README_files/figure-markdown_strict/unnamed-chunk-63-3.png)
